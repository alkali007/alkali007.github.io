...
switch(a){case "Opera":if(C("Opera"))return b(["Version","Opera"]);if(C("OPR"))return b(["OPR"]);break;case "Microsoft Edge":if(C("Edge"))return b(["Edge"]);if(C("Edg/"))return b(["Edg"]);break;case "Chromium":if(Vb())return b(["Chrome","CriOS","HeadlessChrome"])}return"Firefox"===a&&Tb()||"Safari"===a&&Ub()||"Android Browser"===a&&Wb()||"Silk"===a&&C("Silk")?(b=c[2])&&b[1]||"":""}
...
var Wc;if(y.document&&Kc){var Xc=Pc();Wc=Xc?Xc:parseInt(Uc,10)||void 0}else Wc=void 0;var Yc=Wc;var Zc=Ec()||C("iPod"),$c=C("iPad");Wb();Vb();var ad=Ub()&&!(Ec()||C("iPad")||C("iPod"));var bd={},cd=null;
...
;function Ar(a,b){b=void 0===b?{}:b;var c=!1;L("ytLoggingEventsDefaultDisabled",!1)&&kp===kp&&(c=!0);zr(a,c?null:kp,b)}
...
a.params){var ba=a.params;if("object"===typeof a.params)for(var ca in ba){if(ba[ca]){var V="params."+ca,Ua=xr(ba[ca]);g[V]=Ua;O+=V.length+Ua.length;if(500<O)break}}else g.params=xr(ba)}if(m.length)for(var za=0;za<m.length&&!(O=vr(m[za],"params.context."+za,g,O),500<=O);za++);navigator.vendor&&!g.hasOwnProperty("vendor")&&(g["device.vendor"]=navigator.vendor);var H={message:t,name:x,lineNumber:D,fileName:F,stack:N,params:g,sampleWeight:1},Fa=Number(a.columnNumber);isNaN(Fa)||(H.lineNumber=H.lineNumber+
...
Gj,Vj);Ar(Cp)}else{var Dp={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(Dp.systemHealth={crashData:{clientError:{logMessage:{message:H.message}}}});em("appCrashed",Dp)}Kr++}else"WARNING"===h&&sr.qa("handleWarning",H);if(M("kevlar_gel_error_routing"))a:{var ue=h;if(M("errors_via_jspb")){if(Qr())var Fp=void 0;else{var pd=new Vi;E(pd,1,H.stack);H.fileName&&E(pd,4,H.fileName);var Ab=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Ab.length&&(1!==
Ab.length||isNaN(Number(Ab[0]))?2!==Ab.length||isNaN(Number(Ab[0]))||isNaN(Number(Ab[1]))||(E(pd,2,Number(Ab[0])),E(pd,3,Number(Ab[1]))):E(pd,2,Number(Ab[0])));var tc=new Yi;E(tc,1,H.message);E(tc,3,H.name);E(tc,6,H.sampleWeight);"ERROR"===ue?E(tc,2,2):"WARNING"===ue?E(tc,2,1):E(tc,2,0);var Wj=new Wi;E(Wj,1,!0);Ud(Wj,Vi,3,Xi,pd);var Xb=new Si;E(Xb,3,window.location.href);for(var Gp=L("FEXP_EXPERIMENTS",[]),Xj=0;Xj<Gp.length;Xj++){var Bv=Gp[Xj];xd(Xb);Md(Xb,5).push(Bv)}var Yj=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
if(!ok()&&Yj)for(var Hp=p(Object.keys(Yj)),uc=Hp.next();!uc.done;uc=Hp.next()){var Ip=uc.value,Zj=new Ui;E(Zj,1,Ip);Zj.setValue(String(Yj[Ip]));Wd(Xb,4,Ui,Zj)}var ak=H.params;if(ak){var Jp=p(Object.keys(ak));for(uc=Jp.next();!uc.done;uc=Jp.next()){var Kp=uc.value,bk=new Ui;E(bk,1,"client."+Kp);bk.setValue(String(ak[Kp]));Wd(Xb,4,Ui,bk)}}var Lp=L("SERVER_NAME"),Mp=L("SERVER_VERSION");if(Lp&&Mp){var ck=new Ui;E(ck,1,"server.name");ck.setValue(Lp);Wd(Xb,4,Ui,ck);var dk=new Ui;E(dk,1,"server.version");
dk.setValue(Mp);Wd(Xb,4,Ui,dk)}var Hg=new Zi;G(Hg,Si,1,Xb);G(Hg,Wi,2,Wj);G(Hg,Yi,3,tc);Fp=Hg}var Np=Fp;if(!Np)break a;var Op=new Fj;Ud(Op,Zi,163,Gj,Np);Ar(Op)}else{if(Qr())var Pp=void 0;else{var ve={stackTrace:H.stack};H.fileName&&(ve.filename=H.fileName);var Bb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Bb.length&&(1!==Bb.length||isNaN(Number(Bb[0]))?2!==Bb.length||isNaN(Number(Bb[0]))||isNaN(Number(Bb[1]))||(ve.lineNumber=Number(Bb[0]),ve.columnNumber=Number(Bb[1])):ve.lineNumber=
Number(Bb[0]));var ek={level:"ERROR_LEVEL_UNKNOWN",message:H.message,errorClassName:H.name,sampleWeight:H.sampleWeight};"ERROR"===ue?ek.level="ERROR_LEVEL_ERROR":"WARNING"===ue&&(ek.level="ERROR_LEVEL_WARNNING");var Cv={isObfuscated:!0,browserStackInfo:ve},qd={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(qd.experimentIds=L("FEXP_EXPERIMENTS"));var fk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!ok()&&fk)for(var Qp=p(Object.keys(fk)),vc=Qp.next();!vc.done;vc=Qp.next()){var Rp=
vc.value;qd.kvPairs.push({key:Rp,value:String(fk[Rp])})}var gk=H.params;if(gk){var Sp=p(Object.keys(gk));for(vc=Sp.next();!vc.done;vc=Sp.next()){var Tp=vc.value;qd.kvPairs.push({key:"client."+Tp,value:String(gk[Tp])})}}var Up=L("SERVER_NAME"),Vp=L("SERVER_VERSION");Up&&Vp&&(qd.kvPairs.push({key:"server.name",value:Up}),qd.kvPairs.push({key:"server.version",value:Vp}));Pp={errorMetadata:qd,stackTrace:Cv,logMessage:ek}}var Wp=Pp;if(!Wp)break a;em("clientError",Wp)}if("ERROR"===ue||M("errors_flush_gel_always_killswitch"))M("web_fp_via_jspb")&&
lr(!0),lr()}if(!M("suppress_error_204_logging")){var we=H.params||{},Yb={urlParams:{a:"logerror",t:"jserror",type:H.name,msg:H.message.substr(0,250),line:H.lineNumber,level:h,"client.name":we.name},postParams:{url:L("PAGE_NAME",window.location.href),file:H.fileName},method:"POST"};we.version&&(Yb["client.version"]=we.version);if(Yb.postParams){H.stack&&(Yb.postParams.stack=H.stack);for(var Xp=p(Object.keys(we)),hk=Xp.next();!hk.done;hk=Xp.next()){var Yp=hk.value;Yb.postParams["client."+Yp]=we[Yp]}var ik=
L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(ik)for(var Zp=p(Object.keys(ik)),jk=Zp.next();!jk.done;jk=Zp.next()){var $p=jk.value;Yb.postParams[$p]=ik[$p]}var aq=L("SERVER_NAME"),bq=L("SERVER_VERSION");aq&&bq&&(Yb.postParams["server.name"]=aq,Yb.postParams["server.version"]=bq)}Xk(L("ECATCHER_REPORT_HOST","")+"/error_204",Yb)}try{Ir.add(H.message)}catch(ax){}Jr++}}}}
...
function Av(){var a=Number(L("DCLKSTAT",0));return isNaN(a)?0:a}
...
;var Rw=null,Sw=null,Tw=null;function Uw(){Vw()}
function Ww(){Vw()}
function Vw(){var a=Rw.getVideoData(1);a=a.title?a.title+" - YouTube":"YouTube";document.title!==a&&(document.title=a)}
;function Xw(a,b,c){a="ST-"+ic(a).toString(36);b=b?rc(b):"";c=c||5;vs()&&gl(a,b,c)}
;function Yw(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=L("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=L("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=mc(window.location.href);g&&f.push(g);g=mc(d);if(0<=eb(f,g)||!g&&0==d.lastIndexOf("/",0))if(M("autoescape_tempdata_url")&&(f=document.createElement("a"),dc(f,d),d=f.href),d&&(d=nc(d),f=d.indexOf("#"),d=0>f?d:d.slice(0,f)))if(e&&!b.csn&&(b.itct||b.ved)&&(b=Object.assign({csn:gs()},b)),h){var h=parseInt(h,10);isFinite(h)&&0<h&&
Xw(d,b,h)}else Xw(d,b)}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var q=void 0===q?window:q;c=q.location;a=wc(a,k)+m;var t=void 0===t?yh:t;a:{t=void 0===t?yh:t;for(k=0;k<t.length;++k)if(m=t[k],m instanceof wh&&m.isValid(a)){t=new Mb(a,Nb);break a}t=void 0}c.href=Ob(t||Qb)}return!0}
...
"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in c){c=c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER;if(!c.serializedForcedExperimentIds){var d=Ik(window.location.href);d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}Rw=Pw(a,c,!1)}else Rw=Pw(a);Rw.addEventListener("onVideoDataChange",Uw);Rw.addEventListener("onReady",Ww);a=L("POST_MESSAGE_ID","player");L("ENABLE_JS_API")?Tw=new ew(Rw):L("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(Sw=new lw(window.parent,
a,b),Tw=new iw(Rw,Sw.connection));zv();M("ytidb_create_logger_embed_killswitch")||bm();a={};Tv||(Tv=new Sv);Tv.install((a.flush_logs={callback:function(){Qq()}},a));
...
window.addEventListener?(window.addEventListener("load",Zw),window.addEventListener("pagehide",$w)):window.attachEvent&&(window.attachEvent("onload",Zw),window.attachEvent("onunload",$w));z("yt.abuse.player.botguardInitialized",B("yt.abuse.player.botguardInitialized")||Iv);z("yt.abuse.player.invokeBotguard",B("yt.abuse.player.invokeBotguard")||Jv);z("yt.abuse.dclkstatus.checkDclkStatus",B("yt.abuse.dclkstatus.checkDclkStatus")||Av);z("yt.player.exports.navigate",B("yt.player.exports.navigate")||Yw);
